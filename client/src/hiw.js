...
const Hiw = () => {
    return (
        <div className="relative text-[#FAF9F6]/80 font-geneva py-16 mx-auto">
            <div className="absolute inset-x-0 top-[100px] w-[35%] mx-auto bg-[#25897a]/30 rounded-2xl" style={{ height: 'calc(100% - 200px)'}}></div>

            <div className="relative flex flex-col items-center mb-6">
                <div
                    className="relative w-[32%] h-20 shadow-lg flex justify-center items-center"
                    style={{
            ...
            <div className="relative flex justify-center items-center gap-16 mt-10">
                <div className="bg-white p-6 opacity-80 rounded-2xl shadow-lg w-80 transform hover:scale-105 transition duration-300 relative text-center">
            ...
            <div className="relative flex justify-center items-center rounded-lg w-1/2 h-auto mx-auto shadow-lg p-8 mt-10 z-10 border-2 border-[#FAF9F6]/70" style = {{
                background: "radial-gradient(circle, #206c8c, #1d997c)",
            }}>
                <p className="text-center text-[#FAF9F6]/80 text-md leading-relaxed font-light" >
